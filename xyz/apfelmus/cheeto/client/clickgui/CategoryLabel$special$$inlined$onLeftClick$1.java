...
public final class CategoryLabel$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
   // $FF: synthetic field
   final CategoryLabel this$0;

   public CategoryLabel$special$$inlined$onLeftClick$1(CategoryLabel var1) {
      super(2);
      this.this$0 = var1;
   }
