...
public final class ModuleLabel extends UIContainer {
   ...
   public ModuleLabel(@NotNull ConfigGUI gui, @NotNull Object module) {
      ...
      String var3 = CF4M.INSTANCE.moduleManager.getName(this.module);
      Intrinsics.checkNotNullExpressionValue(var3, "INSTANCE.moduleManager.getName(module)");
      UIComponent $this$onLeftClick$iv = (UIComponent)(new UIText(var3, false, (Color)null, 6, (DefaultConstructorMarker)null));
      ...
      $this$_init__u24lambda_u2d1.setTextScale((HeightConstraint)UtilitiesKt.pixels$default((Number)1.5F, false, false, 3, (Object)null));
      ...
      $this$_init__u24lambda_u2d1.setHeight((HeightConstraint)UtilitiesKt.pixels$default((Number)25, false, false, 3, (Object)null));
      $this$onLeftClick$iv = (UIComponent)this;
      $i$f$onLeftClick = false;
      $this$onLeftClick$iv.onMouseClick((Function2)(new ModuleLabel$special$$inlined$onLeftClick$1(this)));
      this.onMouseEnter((Function1)(new Function1<UIComponent, Unit>() {
         public final void invoke(@NotNull UIComponent $this$onMouseEnter) {
            ...
            if (!ModuleLabel.this.isSelected()) {
               UIComponent $this$animate$iv = (UIComponent)ModuleLabel.this.getText();
   ...
   public final void setModuleName(String var1) {
   ...
   static {
      KProperty[] var0 = new KProperty[]{(KProperty)Reflection.property1((PropertyReference1)(new PropertyReference1Impl(ModuleLabel.class, "text", "getText()Lgg/essential/elementa/components/UIText;", 0)))};
