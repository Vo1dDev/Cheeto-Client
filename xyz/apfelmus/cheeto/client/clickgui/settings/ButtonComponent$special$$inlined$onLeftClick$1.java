...
public final class ButtonComponent$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
   // $FF: synthetic field
   final ButtonComponent this$0;

   public ButtonComponent$special$$inlined$onLeftClick$1(ButtonComponent var1) {
      super(2);
      this.this$0 = var1;
   }
