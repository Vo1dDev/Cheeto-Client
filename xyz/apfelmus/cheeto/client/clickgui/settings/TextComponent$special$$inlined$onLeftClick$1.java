...
public final class TextComponent$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
   // $FF: synthetic field
   final TextComponent this$0;

   public TextComponent$special$$inlined$onLeftClick$1(TextComponent var1) {
      super(2);
      this.this$0 = var1;
   }
