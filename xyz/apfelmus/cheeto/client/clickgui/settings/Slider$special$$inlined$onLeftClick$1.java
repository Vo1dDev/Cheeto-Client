...
public final class Slider$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
   // $FF: synthetic field
   final Slider this$0;

   public Slider$special$$inlined$onLeftClick$1(Slider var1) {
      super(2);
      this.this$0 = var1;
   }
   ...
   public final void invoke(@NotNull UIComponent $this$onMouseClick, @NotNull UIClickEvent it) {
      ...
      if (it.getMouseButton() == 0) {
         ...
         Slider.access$setGrabOffset$p(this.this$0, it.getRelativeX() - this.this$0.getGrabBox().getWidth() / (float)2);
         it.stopPropagation();
      }
