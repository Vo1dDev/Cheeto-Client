...
public final class KeybindLabel$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
   // $FF: synthetic field
   final BooleanRef $changing$inlined;
   // $FF: synthetic field
   final ButtonComponent $keybind$inlined;

   public KeybindLabel$special$$inlined$onLeftClick$1(BooleanRef var1, ButtonComponent var2) {
      super(2);
      this.$changing$inlined = var1;
      this.$keybind$inlined = var2;
   }
