...
public final class ModuleLabel$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
   // $FF: synthetic field
   final ModuleLabel this$0;

   public ModuleLabel$special$$inlined$onLeftClick$1(ModuleLabel var1) {
      super(2);
      this.this$0 = var1;
   }
