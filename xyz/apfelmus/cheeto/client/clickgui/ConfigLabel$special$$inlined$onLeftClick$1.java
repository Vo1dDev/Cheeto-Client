...
public final class ConfigLabel$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
   // $FF: synthetic field
   final ConfigLabel this$0;

   public ConfigLabel$special$$inlined$onLeftClick$1(ConfigLabel var1) {
      super(2);
      this.this$0 = var1;
   }
